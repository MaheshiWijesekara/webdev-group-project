...
function Footer() {
    // State to store the email input value for newsletter subscription
    ...
    const handleSubscribe = async (e) => {
        ...
        if (!email) return toast.error("Please enter an email address"); // Validate email input
        ...
        try {
            ...
            // Handle errors - show error message from server or fallback message
        ...
        <div className="footer mt-5 py-5">
            <div className="container">
                <div className="row gy-4">
                    {/* Company Information Section - Left side with 3 columns */}
                    <div className="col-lg-8">
                        <div className="row">
                            {/* Company column - contact details and store info */}
                            <div className="col-md-4">
                                <h3 className="mb-3">Company</h3>
                                <p className="mb-0">Find a store near you</p>
                                <p className="mb-4"><Link to="/stores" className="text-decoration-none" style={{ color: '#d0d0d0' }}>See Our Stores</Link></p>
                                <p className="mb-0"><strong>+1 234 567 890</strong></p>
                                <p>hello@virelle.com</p>
                            </div>
                            
                            {/* Useful Links column - navigation to shop categories */}
                            <div className="col-md-4">
                                <h3 className="mb-3">Useful Links</h3>
                                <ul className="list-unstyled">
                                    <li className="mb-2"><Link to="/shop?sortBy=New" className="text-decoration-none">- New Arrivals</Link></li>
                                    <li className="mb-2"><Link to="/shop?sortBy=best" className="text-decoration-none">- Best Sellers</Link></li>
                                    <li className="mb-2"><Link to="/shop?tag=Sale" className="text-decoration-none">- Bundle & Save</Link></li>
                                    <li className="mb-2"><Link to="/shop" className="text-decoration-none">- Online Gift Cards</Link></li>
                                </ul>
                            </div>
                            
                            {/* Information column - customer service and policy links */}
                            <div className="col-md-4">
                                <h3 className="mb-3">Information</h3>
                                <ul className="list-unstyled">
                                    <li className="mb-2"><Link to="/contact#returns" className="text-decoration-none">- Start a Return</Link></li>
                                    <li className="mb-2"><Link to="/contact" className="text-decoration-none">- Contact Us</Link></li>
                                    <li className="mb-2"><Link to="/contact#faq" className="text-decoration-none">- Shipping FAQ</Link></li>
                                    <li className="mb-2"><Link to="/contact#privacy" className="text-decoration-none">- Privacy Policy</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    
                    {/* Newsletter Section - Right side subscription form */}
                ...
                {/* Footer Bottom Section - Copyright, Logo, and Payment Icons */}
                <div className="footer-bottom mt-5">
                    <div className="row align-items-start">
                        {/* Left side - Copyright text and social media icons */}
                        <div className="col-lg-4">
                            <div className="footer-icon-text d-flex gap-3 justify-content-center justify-content-lg-start">
                                ...
                                <div className="footer-icons d-flex gap-2">
                                    <a href="#" className="text-decoration-none" style={{ color: '#d0d0d0' }}><i className="bi bi-instagram"></i></a>
                                    <a href="#" className="text-decoration-none" style={{ color: '#d0d0d0' }}><i className="bi bi-twitter-x"></i></a>
                                    <a href="#" className="text-decoration-none" style={{ color: '#d0d0d0' }}><i className="bi bi-facebook"></i></a>
                                    <a href="#" className="text-decoration-none" style={{ color: '#d0d0d0' }}><i className="bi bi-youtube"></i></a>
                                </div>
                            </div>
                        </div>
                        
                        {/* Center - Brand logo linking to homepage */}
                        <div className="col-lg-4">
                        ...
                        {/* Right side - Payment method icons */}
                        <div className="col-lg-4">
